...
public class ScannerClass extends AppCompatActivity {
            ...
            mCodeScanner.setDecodeCallback(new DecodeCallback() {
                ...
                public void onDecoded(@NonNull Result result) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ScannerClass.this, result.getText(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
    ...
    private void askPermission() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(ScannerClass.this, new String[]{Manifest.permission.CAMERA}, CAMERA_PERM);
            } else {
